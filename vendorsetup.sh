...
# Sepolicies
rm -rf device/mediatek/sepolicy_vndr && git clone  --depth 1 https://github.com/xiaomi-mediatek-devs/android_device_mediatek_sepolicy_vndr.git device/mediatek/sepolicy_vndr -b lineage-23.0            
